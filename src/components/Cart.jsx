            ...
            <div className="flex items-center gap-5 p-4 leading-8 border-b-1 border-color dark:border-gray-600">
              ...
              <div>
                ...
                <div className="flex items-center gap-4 mt-2">
                  ...
                  <div className="flex items-center rounded border-1 border-color">
                  <button
                    type="button"
                    className="p-3 text-red-600 text-md "
                  >
                    <AiOutlineMinus />
                  </button>
                    <p className="p-2 text-green-600 border-x-1 border-color dark:border-gray-600">0</p>
                    <button
                    type="button"
                    className="p-3 text-green-600 text-md "
                  >
                    <AiOutlinePlus />
                  </button>
                  </div>
